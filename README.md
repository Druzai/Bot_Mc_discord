...
* `op {1} {2}` - give op to {1} player {2} with reason comment, if needed, after set time deop that player
...
```
### Build
First, you have to install pyinstaller via `pip install pyinstaller==4.0`.
<!---->
