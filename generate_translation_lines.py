...
MINECRAFT_ENTITIES = [
    ...
    'Bee', 'Blaze', 'Bogged', 'Breeze', 'Camel', 'Cat', 'Cave Spider', 'Minecart with Chest', 'Chicken', 'Cod',
    'Minecart with Command Block', 'Cow', 'Creaking', 'Creeper', 'Dolphin', 'Donkey', 'Dragon Fireball', 'Drowned',
    'Thrown Egg', 'Elder Guardian', 'End Crystal', 'Ender Dragon', 'Thrown Ender Pearl', 'Enderman', 'Endermite',
    'Evoker', "Thrown Bottle o' Enchanting", 'Experience Orb', 'Fireball', 'Firework Rocket', 'Fox', 'Frog',
    ...
    'Minecart', 'Mooshroom', 'Mule', 'Ocelot', 'Ominous Item Spawner', 'Panda', 'Parrot', 'Phantom', 'Pig', 'Piglin',
    'Piglin Brute', 'Pillager', 'Polar Bear', 'Pufferfish', 'Rabbit', 'Ravager', 'Salmon', 'Sheep', 'Shulker',
    'Silverfish', 'Skeleton', 'Skeleton Horse', 'Slime', 'Small Fireball', 'Sniffer', 'Snow Golem', 'Snowball',
    'Minecart with Monster Spawner', 'Spectral Arrow', 'Spider', 'Squid', 'Stray', 'Strider', 'Tadpole', 'Primed TNT',
    'Minecart with TNT', 'Trader Llama', 'Trident', 'Tropical Fish', 'Anemone', 'Black Tang', 'Blue Tang',
