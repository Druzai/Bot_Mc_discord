...
DEATH_MESSAGES = [
    ...
    '{0} was struck by lightning while fighting {1}', '{0} was killed by magic',
    '{0} was killed by magic while trying to escape {1}', '{0} was slain by {1}', '{0} was slain by {1} using {2}',
    '{0} burned to death', '{0} was burned to a crisp while fighting {1} wielding {2}',
    '{0} was burned to a crisp while fighting {1}', '{0} fell out of the world',
    "{0} didn't want to live in the same world as {1}", '{0} left the confines of this world',
    '{0} left the confines of this world while fighting {1}', '{0} was obliterated by a sonically-charged shriek',
