...
IPv4_REGEX = r"^((25[0-5]|(2[0-4]|1\d|[1-9]|)\d)(\.(?!$)|$)){4}$"
EMOJI_REGEX = r"<a?:\w+:\d+>"
...
DEATH_MESSAGES = [
    ...
    '{0} froze to death', '{0} was frozen to death by {1}', '{0} died', '{0} was killed',
    '{0} was killed whilst fighting {1}', '{0} died because of {1}', '{0} discovered the floor was lava',
    '{0} walked into the danger zone due to {1}', '{0} was killed by {1} using magic',
    '{0} was killed by {1} using {2}', '{0} went up in flames', '{0} walked into fire whilst fighting {1}',
    '{0} suffocated in a wall', '{0} suffocated in a wall whilst fighting {1}', '{0} tried to swim in lava',
    ...
    '{0} was burnt to a crisp whilst fighting {1}', '{0} left the confines of this world',
    '{0} left the confines of this world whilst fighting {1}', '{0} fell out of the world',
